...
from src.evaluation_function import naive_evaluation_function, elaborate_evaluation_function
from src.evaluation_functions import position_evaluation
from src.constants import GAME_TITLE, HEIGHT, TOTAL_WIDTH, BOT_COLOR, BOT_EVALUATION_DEPTH, VISUALIZE
from src.draw_chessboard import animate_holding_piece, animate_moving_piece, draw_board, draw_notepad, draw_pieces
import src.events as events
from src.chess_board import ChessBoard
from src.utils import load_background_image, load_notepad_background_image, load_piece_images
...
def run_game(bot:bool, grid = None):
    ...
    while running:
        ...
        # Bots turn
        if bot and not board.game_is_over and board.turn == BOT_COLOR:
        ...
        draw_notepad(screen, board, notepad_background_image, selected_square, BOT_EVALUATION_FUNCTION)
